    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .s-section { font-size: 9px; letter-spacing: 3px; text-transform: uppercase; color: ${C.muted}; padding-bottom: 6px; border-bottom: 1px solid ${C.rule}; margin-bottom: 14px; margin-top: 20px; }
